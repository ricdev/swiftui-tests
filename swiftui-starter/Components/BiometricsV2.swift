...
class BiometricsV2 {
    ...
    static let shared = BiometricsV2()
    ...
    init(policy: LAPolicy = .deviceOwnerAuthenticationWithBiometrics, localizedReason: String = "Verify Identity", localizedFallbackTitle: String = "Enter Password") {
